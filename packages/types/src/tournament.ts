...
export const updateTournamentRequestSchema =
	createTournamentRequestSchema.partial();
...
export const listTournamentsResponseSchema =
	paginatedSchema(tournamentDtoSchema);
